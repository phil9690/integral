...
module Integral
  describe PagesController do
        ...
        context 'when user has required privileges' do
          context 'when valid page params supplied' do
            it 'returns status created' do
              ...
              expect(response).to redirect_to edit_page_path(assigns[:page])
            end
          ...
          context 'when invalid page params supplied' do
            it 'does not save a new page' do
              expect {
                post :create, page: page_params.merge!(title: '')
    ...
    describe 'PUT update' do
      ...
      context 'when not logged in' do
        before { put :update, id: page.id, page: page_params }
      ...
      context 'when logged in' do
        ...
        context 'when user does not have required privileges' do
          ...
          before do
            put :update, id: page.id, page: page_params
          end
        ...
        context 'when user has required privileges' do
          ...
          context 'when invalid parameters supplied' do
            ...
            it { expect(flash[:error]).to eq I18n.t('integral.pages.notification.edit_failure') }
    ...
    describe 'DELETE destroy' do
      ...
      context 'when logged in' do
        ...
        context 'when user has required privileges' do
          ...
          it { expect(flash[:notice]).to eq I18n.t('integral.pages.notification.delete_success') }
        ...
        context 'when no problem occurs destroying' do
          ...
          it { expect { page.reload }.not_to raise_error }
          it { expect(flash[:error]).to eq I18n.t('integral.pages.notification.delete_failure') }
          it { expect(response).to redirect_to pages_path }
        end
      end
    end
