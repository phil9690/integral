module Integral
  ...
  class MenusController < ApplicationController
    ...
    def menu_params
      params.require(:menu).permit(:title, :description, :html_id, :html_classes, menu_items_attributes: [:id, :type, :object_type, :object_id,  :title, :url, :image_id, :target, :priority, :_destroy, :description, :html_classes, children_attributes: [:id, :type, :object_type, :object_id, :title, :url, :image_id, :target, :priority, :description, :html_classes, :_destroy]])
    end
